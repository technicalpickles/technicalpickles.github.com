...
It's been awhile, dear reader. After a lull in development, Jeweler 1.5.1 is finally released. I spent a lot of time cleaning up and revising the README, so I'm just going to put that right here. It tells the story of going from 0 to jewelered, so I don't think it's a cop out :)
